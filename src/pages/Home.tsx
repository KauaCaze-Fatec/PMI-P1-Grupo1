...
export default function Home() {
  ...
  return (
    <>
      <NavInstitucional />
      <main className="mx-auto flex max-w-2xl flex-col gap-6 p-6 text-center">
        <h1 className="text-3xl font-bold">Simulado ENADE 2021 — Ciência da Computação</h1>
        <p className="text-neutral-600 dark:text-neutral-400">
          Pratique com as 35 questões objetivas do componente específico da prova do ENADE 2021
          para o Bacharelado em Ciência da Computação, com correção imediata, cronômetro e
          comparativo de estatísticas oficiais de acerto do INEP.
        </p>

        <p className="text-sm text-neutral-500 dark:text-neutral-500">
          O ENADE (Exame Nacional de Desempenho dos Estudantes) integra o SINAES e é um dos
          componentes usados no cálculo do CPC (Conceito Preliminar de Curso) das instituições de
          ensino superior.
        </p>
        ...
        <button
          ...
          className="mx-auto rounded-lg bg-blue-600 px-6 py-3 text-base font-semibold text-white hover:bg-blue-700"
        >
          Iniciar Simulado
        </button>
